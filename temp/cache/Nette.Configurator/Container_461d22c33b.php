...
class Container_461d22c33b extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'security.user',
					'session.session',
					'25_App_AdminModule_model_UserManager',
			...
			'Nette\Security\IAuthenticator' => array(
				1 => array('25_App_AdminModule_model_UserManager'),
			),
			...
			'App\AdminModule\Presenters\SignPresenter' => array(array('application.1', 'application.3')),
			...
			'App\FrontendModule\Presenters\Error4xxPresenter' => array(array('application.4')),
			'App\FrontendModule\Presenters\ErrorPresenter' => array(array('application.5')),
			'App\FrontendModule\Presenters\HomepagePresenter' => array(array('application.6')),
		...
		'services' => array(
			'25_App_AdminModule_model_UserManager' => 'App\AdminModule\model\UserManager',
			...
			'application.4' => 'App\FrontendModule\Presenters\Error4xxPresenter',
			'application.5' => 'App\FrontendModule\Presenters\ErrorPresenter',
			'application.6' => 'App\FrontendModule\Presenters\HomepagePresenter',
	 ...
	 */
	public function createService__25_App_AdminModule_model_UserManager()
	{
	...
	{
		$service = new App\Forms\SignForm($this->getService('26_App_Forms_FormFactory'), $this->getService('security.user'));
		return $service;
	}
	...
	public function createServiceApplication__1()
	{
		...
		$service->connection = $this->getService('connection');
	...
	public function createServiceApplication__2()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			...
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->connection = $this->getService('connection');
		$service->singInForm = $this->getService('27_App_Forms_SignForm');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('25_App_AdminModule_model_UserManager'));
